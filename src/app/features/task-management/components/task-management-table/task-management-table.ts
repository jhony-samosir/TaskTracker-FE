...
@Component({
  ...
  imports: [CommonModule, MatButtonModule, MatIconModule, MatMenuModule, MatTableModule, MatTooltipModule],
...
export class TaskManagementTable {
  ...
  protected readonly displayedColumns = ['title', 'assignee', 'status', 'priority', 'deadline', 'actions'];
